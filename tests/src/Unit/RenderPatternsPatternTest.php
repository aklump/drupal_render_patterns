...
class RenderPatternsPatternTest extends UnitTestCase {
  ...
  /**
   * @expectedException RenderPatternsPatternException
   */
...
class LegacyPattern extends RenderPatternsPattern {
...
class BravoPattern extends RenderPatternsPattern {
...
class AlphaPattern extends RenderPatternsPattern {
  ...
  public function default__counter($default) {
    ...
    return RenderPatternsUncacheable::value(++$counter);
  }
